...
let solve_rec ((Rec (Term rec_term, Inc inc)) : lin_rec) : lin_rec_sol =
  failwith "Not implemented" (*TODO: replace this line with your solution. *)
  (*Hint: The solution will look like RecSol(Term rec_term, Times (something)).
          Make sure to use the special constructor K in your solution.*)
